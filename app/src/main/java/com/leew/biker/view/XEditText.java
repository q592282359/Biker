...
public class XEditText extends AppCompatEditText {
    ...
    public XEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (disableEmoji) {
            setFilters(new InputFilter[]{new XEditText.EmojiExcludeFilter()});
        }

        mTextWatcher = new XEditText.MyTextWatcher();
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean disableTogglePwdDrawable = a.getBoolean( R.styleable.XEditText_x_togglePwdDrawableEnable, false);
